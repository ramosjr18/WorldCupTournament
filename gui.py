...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.semifinals_Frame.grid_columnconfigure((0,1,2,3), weight=1)
        ...
        self.semifinaltitlelabel.grid(row=0, column=1, columnspan=2, padx=(20, 20), pady=(20, 0))
        self.firstsemi_frame = customtkinter.CTkFrame(self.semifinals_Frame)
        self.firstsemi_frame.grid(row=1, column=0, columnspan=2, rowspan=2, padx=(0, 0), pady=(0, 0))
        self.secondsemi_frame = customtkinter.CTkFrame(self.semifinals_Frame)
        self.secondsemi_frame.grid(row=1, column=2, columnspan=2, rowspan=2, padx=(0, 0), pady=(0, 0))
        ...
        self.thirdplace_Frame.grid_columnconfigure((0,1,2,3,4), weight=1)
        self.thirdplace_Frame.grid_rowconfigure((1,2,3,4,5), weight=1)
        self.titlelabelthirdplace = customtkinter.CTkLabel(self.thirdplace_Frame, text="3rd Place", font=customtkinter.CTkFont(size=30, weight="bold"))
        self.titlelabelthirdplace.grid(row=0, column=1, columnspan=3, padx=(20, 20), pady=(20, 10))
        self.inlabelthirdplace1 = customtkinter.CTkLabel(self.thirdplace_Frame,text="Finalist 1",font=customtkinter.CTkFont(size=15))
        self.inlabelthirdplace1.grid(row=1, column=1, columnspan=2, padx=(10, 10), pady=(10, 10))
        self.inlabelthirdplace5 = customtkinter.CTkLabel(self.thirdplace_Frame,text="0",font=customtkinter.CTkFont(size=15))
        self.inlabelthirdplace5.grid(row=1, column=3, padx=(10, 10), pady=(10, 10))
        self.inlabelthirdplace2 = customtkinter.CTkLabel(self.thirdplace_Frame,text="VS",font=customtkinter.CTkFont(size=15))
        self.inlabelthirdplace2.grid(row=2, column=1,columnspan=3,padx=(20, 20), pady=(10, 20), sticky="nsew")
        self.inlabelthirdplace3 = customtkinter.CTkLabel(self.thirdplace_Frame,text="Finalist 2",font=customtkinter.CTkFont(size=15))
        self.inlabelthirdplace3.grid(row=3, column=1,columnspan=2,padx=(20, 20), pady=(10, 20), sticky="nsew")
        self.inlabelthirdplace4 = customtkinter.CTkLabel(self.thirdplace_Frame,text="0",font=customtkinter.CTkFont(size=15))
        self.inlabelthirdplace4.grid(row=3, column=3,padx=(20, 20), pady=(10, 20), sticky="nsew")
        self.thirdplace_button_1 = customtkinter.CTkButton(master=self.thirdplace_Frame, text="Add Result", text_color=("gray10", "#DCE4EE"), command=self.AutoGenerateButtonEvent)
        self.thirdplace_button_1.grid(row=4, column=1,columnspan=3,padx=(20, 20), pady=(10, 20), sticky="nsew")
        ...
        self.final_Frame.grid_columnconfigure((0,1,2,3,4), weight=1)
        self.final_Frame.grid_rowconfigure((1,2,3,4,5), weight=1)
        self.titlelabelfinal = customtkinter.CTkLabel(self.final_Frame, text="Final", font=customtkinter.CTkFont(size=30, weight="bold"))
        self.titlelabelfinal.grid(row=0, column=1, columnspan=3, padx=(20, 20), pady=(20, 10))
        self.inlabelfinal1 = customtkinter.CTkLabel(self.final_Frame,text="Finalist 1",font=customtkinter.CTkFont(size=15))
        self.inlabelfinal1.grid(row=1, column=1, columnspan=2, padx=(10, 10), pady=(10, 10))
        self.inlabelfinal5 = customtkinter.CTkLabel(self.final_Frame,text="0",font=customtkinter.CTkFont(size=15))
        self.inlabelfinal5.grid(row=1, column=3, padx=(10, 10), pady=(10, 10))
        self.inlabelfinal2 = customtkinter.CTkLabel(self.final_Frame,text="VS",font=customtkinter.CTkFont(size=15))
        self.inlabelfinal2.grid(row=2, column=1,columnspan=3,padx=(20, 20), pady=(10, 20), sticky="nsew")
        self.inlabelfinal3 = customtkinter.CTkLabel(self.final_Frame,text="Finalist 2",font=customtkinter.CTkFont(size=15))
        self.inlabelfinal3.grid(row=3, column=1,columnspan=2,padx=(20, 20), pady=(10, 20), sticky="nsew")
        self.inlabelfinal4 = customtkinter.CTkLabel(self.final_Frame,text="0",font=customtkinter.CTkFont(size=15))
        self.inlabelfinal4.grid(row=3, column=3,padx=(20, 20), pady=(10, 20), sticky="nsew")
        self.final_button_1 = customtkinter.CTkButton(master=self.final_Frame, text="Add Result", text_color=("gray10", "#DCE4EE"), command=self.AutoGenerateButtonEvent)
        self.final_button_1.grid(row=4, column=1,columnspan=3,padx=(20, 20), pady=(10, 20), sticky="nsew")
