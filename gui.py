...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.AddResultsButton = customtkinter.CTkButton(self.groupA_frame, text="Add Results", command=self.get_input)
        ...
        def SaveTeams():
            ...
            self.labelTeamAone.configure(text=self.groups[0].get_team1())
